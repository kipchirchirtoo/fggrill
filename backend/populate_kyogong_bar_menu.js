...
const barMenuItems = [
  ...
  { name: 'PILSNER', category: 'Beers', price: 250, unit: 'bottle' },
  { name: 'MANYATTA', category: 'Beers', price: 300, unit: 'bottle' },
  { name: 'GUINNESS SMOOTH', category: 'Beers', price: 200, unit: 'bottle' },
  { name: 'DESPARADO', category: 'Beers', price: 350, unit: 'bottle' },
  { name: 'HUNTERS BEER', category: 'Beers', price: 300, unit: 'bottle' },
  { name: 'TUSKER NDIMU', category: 'Beers', price: 200, unit: 'bottle' },
  ...
  { name: 'SNAPP CAN', category: 'Canned Beers', price: 250, unit: 'can' },
  { name: 'QUARANA PUNCH', category: 'Canned Beers', price: 250, unit: 'can' },
  { name: 'Gordons can', category: 'Canned Beers', price: 300, unit: 'can' },
  { name: 'FAXE CAN', category: 'Canned Beers', price: 400, unit: 'can' },
  { name: 'BALOZI CAN', category: 'Canned Beers', price: 270, unit: 'can' },
  ...
  { name: 'B/WHISKY 1/4', category: 'Whisky', price: 450, unit: 'bottle' },
  ...
  { name: 'B S W 1/2', category: 'Whisky', price: 800, unit: 'bottle' },
  { name: 'B S W 3/4', category: 'Whisky', price: 1500, unit: 'bottle' },
  ...
  try {
    ...
    for (const item of barMenuItems) {
      ...
      const existingRes = await client.query(
        "SELECT sku FROM simple_items WHERE sku = $1 OR (item_name = $2 AND category = $3)",
        [sku, item.name, item.category]
      );
      ...
      try {
        await client.query(
          ...
          [
            ...
            item.category,
            'bar_store',
            Math.round(item.price * 0.7), // cost price at 70% of selling price
            item.price,
            item.unit,
            true,
            branchId
        ...
        // Add to branch_stock for Kyogong
        await client.query(
