...
const REGISTRY: EntityConfig[] = [
  // ── Staff & HR ────────────────────────────────────────────────────────────
  {
    ...
    searchColumns: ['first_name', 'last_name', 'email', 'phone', 'id_number', 'national_id', 'position', 'department', 'role', 'mpesa_number', 'kra_pin'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['email', 'first_name', 'last_name', 'phone_number', 'employee_id', 'role', 'department'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['status', 'shift_type', 'notes'],
    titleColumns: ['status'], subtitleColumns: ['shift_type', 'attendance_date'],
    dateColumn: 'attendance_date', statusColumn: 'status',
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['employee_name', 'employee_code', 'national_id'],
    titleColumns: ['employee_name'], subtitleColumns: ['employee_code'],
  ...
  },
  {
    ...
    titleColumns: ['reason'], subtitleColumns: ['status'],
    dateColumn: 'loan_date', amountColumn: 'total_amount', statusColumn: 'status',
    editableColumns: ['reason', 'status', 'monthly_installment', 'installment_amount', 'remaining_balance'],
  ...
  },
  {
    ...
    editableColumns: ['reason', 'status', 'amount'],
    deletable: true, creatable: false,
  },
  {
  ...
  // ── Financial ───────────────────────────────────────────────────────────
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['category', 'description', 'status', 'approval_status'],
    titleColumns: ['category'], subtitleColumns: ['description'],
    dateColumn: 'expense_date', amountColumn: 'amount', statusColumn: 'status',
    editableColumns: ['category', 'description', 'amount', 'status', 'approval_status', 'rejection_reason'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['bank_name', 'reference_number', 'receipt_number', 'account_name', 'purpose_description', 'purpose_category', 'notes', 'transaction_type', 'status'],
    titleColumns: ['transaction_type', 'bank_name'], subtitleColumns: ['reference_number', 'purpose_description'],
    dateColumn: 'transaction_date', amountColumn: 'amount', statusColumn: 'status',
    editableColumns: ['bank_name', 'account_name', 'account_number', 'reference_number', 'receipt_number', 'purpose_category', 'purpose_description', 'notes', 'amount', 'status'],
  ...
  },
  {
    ...
    editableColumns: ['category', 'description', 'amount', 'status', 'notes'],
    deletable: true, creatable: true, requiredOnCreate: ['category', 'amount'],
  },
  {
    type: 'journal_entry', label: 'Journal Entry', group: 'Financial', icon: 'book', table: 'accounting_journal_entries',
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['journal_number', 'description', 'reference', 'status'],
    titleColumns: ['journal_number', 'description'], subtitleColumns: ['reference'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['request_type', 'description', 'notes', 'status'],
  ...
  // ── POS & Orders ──────────────────────────────────────────────────────────
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['order_number', 'bill_number', 'guest_name', 'table_number', 'room_number', 'status', 'payment_method', 'payment_status'],
    titleColumns: ['order_number'], subtitleColumns: ['guest_name', 'status'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['order_number', 'guest_name', 'room_number', 'status', 'payment_method', 'payment_status'],
    titleColumns: ['order_number'], subtitleColumns: ['guest_name', 'status'],
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['transaction_number', 'customer_name', 'customer_phone', 'payment_reference', 'remarks', 'transaction_type', 'revenue_type'],
    ...
    editableColumns: ['remarks'],
    deletable: false, creatable: false,
  },
  {
    type: 'shift_transaction', label: 'Shift Transaction', group: 'POS & Orders', icon: 'receipt', table: 'shift_transactions',
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['transaction_number', 'customer_name', 'customer_phone', 'service_category', 'transaction_type', 'mpesa_reference'],
    titleColumns: ['transaction_number'], subtitleColumns: ['customer_name', 'service_category'],
  ...
  // ── Purchases & Procurement ───────────────────────────────────────────────
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['requisition_number', 'reason', 'status', 'priority', 'notes'],
    titleColumns: ['requisition_number'], subtitleColumns: ['status', 'priority'],
    dateColumn: 'requested_at', statusColumn: 'status',
    editableColumns: ['reason', 'status', 'priority', 'notes'],
    deletable: false, creatable: false,
  },
  {
    ...
    searchColumns: ['po_number', 'status', 'priority'],
    titleColumns: ['po_number'], subtitleColumns: ['status', 'priority'],
    dateColumn: 'po_date', amountColumn: 'total_amount', statusColumn: 'status',
    editableColumns: ['status', 'priority', 'expected_delivery_date'],
    deletable: false, creatable: false,
  },
  // ── Rooms & Bookings ──────────────────────────────────────────────────────
  {
    ...
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['confirmation_number', 'status', 'special_requests', 'notes', 'booking_source', 'purpose'],
    ...
    editableColumns: ['status', 'notes', 'internal_notes', 'special_requests'],
    deletable: false, creatable: false,
  },
  {
    type: 'room', label: 'Room', group: 'Rooms & Bookings', icon: 'bed', table: 'rooms',
    branchColumn: 'branch_id', branchMode: 'eq',
    searchColumns: ['room_number', 'status', 'room_type', 'notes', 'building'],
    titleColumns: ['room_number'], subtitleColumns: ['room_type', 'status'],
    statusColumn: 'status',
    editableColumns: ['status', 'notes', 'hk_status'],
    deletable: false, creatable: false,
  },
  // ── Menu (shared / branch) ────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    branchColumn: 'branch_id', branchMode: 'nullable',
    searchColumns: ['name', 'description', 'unit'],
    titleColumns: ['name'], subtitleColumns: ['unit'],
    amountColumn: 'price', statusColumn: 'is_available',
    editableColumns: ['name', 'description', 'price', 'cost_price', 'is_available'],
    deletable: false, creatable: false,
  },
];
