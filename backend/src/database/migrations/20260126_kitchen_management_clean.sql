...
CREATE INDEX IF NOT EXISTS idx_k_main_stock_branch ON kitchen_stock(branch_id);
CREATE INDEX IF NOT EXISTS idx_k_main_stock_sku ON kitchen_stock(item_sku);
...
CREATE INDEX IF NOT EXISTS idx_k_main_req_branch ON kitchen_requisitions(branch_id);
CREATE INDEX IF NOT EXISTS idx_k_main_req_status ON kitchen_requisitions(status);
CREATE INDEX IF NOT EXISTS idx_k_main_req_date ON kitchen_requisitions(requested_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_k_main_req_items_req ON kitchen_requisition_items(requisition_id);
...
CREATE INDEX IF NOT EXISTS idx_k_main_grn_branch ON kitchen_grn(branch_id);
CREATE INDEX IF NOT EXISTS idx_k_main_grn_req ON kitchen_grn(requisition_id);
...
CREATE INDEX IF NOT EXISTS idx_k_main_grn_items_grn ON kitchen_grn_items(grn_id);
...
CREATE INDEX IF NOT EXISTS idx_k_main_usage_branch_date ON kitchen_usage(branch_id, usage_date DESC);
CREATE INDEX IF NOT EXISTS idx_k_main_usage_type ON kitchen_usage(usage_type);
CREATE INDEX IF NOT EXISTS idx_k_main_usage_order ON kitchen_usage(linked_order_id);
...
CREATE INDEX IF NOT EXISTS idx_k_main_wastage_branch_date ON kitchen_wastage(branch_id, wastage_date DESC);
CREATE INDEX IF NOT EXISTS idx_k_main_wastage_reason ON kitchen_wastage(reason);
...
CREATE INDEX IF NOT EXISTS idx_k_main_variance_branch_date ON kitchen_daily_variance(branch_id, variance_date DESC);
CREATE INDEX IF NOT EXISTS idx_k_main_variance_flagged ON kitchen_daily_variance(is_flagged);
...
DROP TRIGGER IF EXISTS trigger_update_kitchen_stock ON kitchen_stock_ledger;
...
DROP TRIGGER IF EXISTS trigger_gen_requisition_number ON kitchen_requisitions;
...
DROP TRIGGER IF EXISTS trigger_gen_grn_number ON kitchen_grn;
...
DROP TRIGGER IF EXISTS trigger_calc_recipe_cost ON recipe_items;
