...
router.get('/verify/sold-items', authorize([UserRole.AUDITOR, UserRole.SUPER_ADMIN, UserRole.GENERAL_MANAGER, UserRole.BRANCH_MANAGER, UserRole.BRANCH_ACCOUNTANT, UserRole.BRANCH_STOREKEEPER]), getSoldItemsAnalysis);
router.get('/verify/sold-items/export/pdf', authorize([UserRole.AUDITOR, UserRole.SUPER_ADMIN, UserRole.GENERAL_MANAGER, UserRole.BRANCH_MANAGER, UserRole.BRANCH_ACCOUNTANT, UserRole.BRANCH_STOREKEEPER]), exportSoldItemsAnalysisPDF);
