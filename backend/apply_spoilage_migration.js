...
async function run() {
  ...
  console.log('Using URL:', directUrl.replace(/:[^:@/]+@/, ':***@')); // Hide password
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'src', 'database', 'migrations', '20260628_spoilage_staff_accountability.sql');
