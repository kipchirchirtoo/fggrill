...
async function manualApproveGRNs() {
    const client = await pool.connect();
    
    try {
        console.log('========================================');
        console.log(' MANUALLY APPROVING GRNs');
        console.log('========================================\n');
        ...
        for (const grn of grnsQuery.rows) {
            console.log(`🔄 Processing ${grn.grn_number}...`);
            ...
            for (const item of itemsQuery.rows) {
                ...
                console.log(`   - Updating ${sku}: +${qty} units`);
            ...
            console.log(`✅ ${grn.grn_number} - Approved and stock updated!\n`);
        }
