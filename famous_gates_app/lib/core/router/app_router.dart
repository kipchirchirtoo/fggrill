...
const _superAdminSectionRouteSpecs = <MapEntry<String, SuperAdminSection>>[
  ...
  MapEntry('/admin/id-cards', SuperAdminSection.idCards),
  ...
  MapEntry('/admin/wastage', SuperAdminSection.wastageAnalytics),
  MapEntry('/admin/system/roles/migration', SuperAdminSection.roleMigration),
  MapEntry('/cashier', SuperAdminSection.cashierStation),
  MapEntry('/branch-accounting/bookings-invoices',
      SuperAdminSection.bookingsInvoices),
  MapEntry('/admin/staff', SuperAdminSection.personnelRegistry),
  MapEntry('/admin/docs', SuperAdminSection.employeeDocs),
  MapEntry('/communications', SuperAdminSection.communications),
