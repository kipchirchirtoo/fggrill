// Module guides data — ported from frontend/src/app/dashboard/admin/docs/module-guides.ts
...
const List<ModuleGuide> kModuleGuides = [
  ModuleGuide(
    id: 'auditor',
    title: 'Auditor Module',
    iconKey: 'ShieldCheck',
    description:
        'The internal control and compliance hub for verifying system integrity and financial accuracy.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Package',
    description:
        'Managing local branch inventory, ensuring supply availability, and tracking usage.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Truck',
    description:
        'The warehouse master responsible for the entire supply chain and branch fulfillment.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Landmark',
    description:
        'Managing branch-level finances, payments, bankings, and local expenditure.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Bed',
    description:
        'The front-facing operational module for managing guest stays and room inventory.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Shield',
    description:
        'The master control center for system configuration, security, and global oversight.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Utensils',
    description:
        'Detailed service-point interface for taking food and beverage orders and managing table tabs.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'TrendingUp',
    description:
        'Oversight tools for Branch Managers and GMs to monitor performance and drive results.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Users',
    description:
        'Complete lifecycle management of company employees from onboarding to payroll.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Wallet',
    description:
        'The centralized revenue hub for bill settlement, payment verification, and master shift management.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'RefreshCw',
    description:
        'Dedicated POS interfaces for specialized service points such as Spa, Specialty Bars, and Lounges.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Layout',
    description:
        'Real-time order visualization for kitchen staff to manage food preparation and timing.',
    features: [
...
''',
  ...
  ModuleGuide(
    ...
    iconKey: 'Activity',
    description:
        'Back-of-house management for recipes, wastage, and kitchen inventory requisitions.',
    features: [
