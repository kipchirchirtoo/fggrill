...
class _$InventoryItemImpl implements _InventoryItem {
  ...
  @override
  String toString() {
    return 'InventoryItem(id: $id, name: $name, sku: $sku, category: $category, unit: $unit, quantity: $quantity, reorderLevel: $reorderLevel, status: $status, supplierId: $supplierId, supplierName: $supplierName, branchId: $branchId, unitCost: $unitCost, totalValue: $totalValue)';
  }
