      ...
      {activeRequests.length > 0 && (
        <IOSCard className="mt-4 p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-semibold font-sf-pro-display text-gray-900">Active Requests</h3>
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {activeRequests.slice(0, 5).map(request => {
              ...
              return (
                <div key={request.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-ios-lg">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-ios-lg ${config?.color || 'bg-gray-100'}`}>
            ...
            {!selectedDepartment ? (
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex items-center justify-between p-3 bg-[#F2F2F7] rounded-ios-lg">
                    <div className="flex items-center gap-2">
                      {(() => {
