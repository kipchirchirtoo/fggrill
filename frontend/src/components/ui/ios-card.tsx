...
const cardVariants = cva(
  "rounded-lg bg-white dark:bg-[#1C1C1E] text-black dark:text-white overflow-hidden", 
  {
    variants: {
      variant: {
        default: "border border-[#E5E5EA] dark:border-[#38383A]", 
        elevated: "shadow-[0_1px_4px_rgba(0,0,0,0.04)]",
        filled: "bg-[#F2F2F7] dark:bg-[#2C2C2E]",
        outlined: "border border-[#E5E5EA] dark:border-[#38383A]",
        glass: "bg-white/80 dark:bg-[#1C1C1E]/80",
      },
      padding: {
        none: "p-0",
        xs: "p-2",
  ...
  ({ className, size = 'md', children, ...props }, ref) => {
    ...
    return (
      <h3
        ref={ref}
        className={cn(
          'font-sf-pro-display font-semibold font-sf-pro-display tracking-tight text-black dark:text-white',
          sizeClasses[size],
          className
        )}
        {...props}
