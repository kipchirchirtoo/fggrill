    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold">Close Shift - {currentShift?.shift_number}</DialogTitle>
                ...
                <Tabs defaultValue="cash" className="w-full">
                    <TabsList className="grid w-full grid-cols-4">
                        <TabsTrigger value="cash">Cash Float</TabsTrigger>
                    ...
                    <TabsContent value="cash" className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-stone-50 rounded-lg">
                                <p className="text-xs text-stone-500 font-bold uppercase mb-1">Opening Float</p>
                                <p className="text-2xl font-bold text-stone-900">
                                    KES {currentShift?.opening_float?.toLocaleString() || 0}
                                </p>
                            </div>
                            <div className="p-4 bg-emerald-50 rounded-lg">
                                <p className="text-xs text-emerald-600 font-bold uppercase mb-1">Cash Sales</p>
                        ...
                        {formData.closing_float > 0 && (
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-blue-50 rounded-lg">
                                    <p className="text-xs text-blue-600 font-bold uppercase mb-1">Expected</p>
                                    <p className="text-xl font-bold text-blue-700">
                                        KES {expectedClosing?.toLocaleString()}
                                    </p>
                                </div>
                                <div className={`p-4 rounded-lg ${variance === 0 ? 'bg-emerald-50' : variance > 0 ? 'bg-orange-50' : 'bg-rose-50'}`}>
                                    <p className={`text-xs font-bold uppercase mb-1 ${variance === 0 ? 'text-emerald-600' : variance > 0 ? 'text-orange-600' : 'text-rose-600'}`}>
                                        Variance
                                    </p>
                                    <p className={`text-xl font-bold ${variance === 0 ? 'text-emerald-700' : variance > 0 ? 'text-orange-700' : 'text-rose-700'}`}>
                    ...
                    <TabsContent value="revenue" className="space-y-4">
                        ...
                        <div className="p-4 bg-emerald-50 rounded-lg">
                            <p className="text-xs text-emerald-600 font-bold uppercase mb-1">Total Revenue</p>
                            <p className="text-2xl font-bold text-emerald-700">
                    ...
                    <TabsContent value="credit" className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label>Credit Bills Taken (Value)</Label>
                                <Input
                                    type="number"
                            ...
                            <div className="space-y-2">
                                <Label>Number of Credit Bills</Label>
                                <Input
                                    type="number"
                            ...
                            <div className="space-y-2">
                                <Label>Unpaid Bills (Value)</Label>
                                <Input
                                    type="number"
                            ...
                            <div className="space-y-2">
                                <Label>Number of Unpaid Bills</Label>
                                <Input
                                    type="number"
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg">
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    <p className="font-bold text-blue-900 mb-1">Credit & Unpaid Bills</p>
                                    <p className="text-sm text-blue-700">
                                        Track credit bills issued and unpaid bills at shift end for accurate reconciliation.
                                    </p>
                                </div>
                            </div>
                        </div>
