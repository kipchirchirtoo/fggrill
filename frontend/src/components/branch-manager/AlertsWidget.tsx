...
import { 
  ...
  Users, Package, RefreshCw, ChevronRight 
} from 'lucide-react';
    ...
    try {
      ...
      const stockAlerts: Alert[] = (stockResponse.data?.suggestions || [])
        ...
        .map((s: any) => ({
          id: `stock-${s.item_sku}`,
          type: 'stock' as const,
          severity: s.priority === 'urgent' ? 'urgent' as const : 'high' as const,
      ...
      // Combine all alerts
      const allAlerts = [...stockAlerts, ...approvalAlerts]
        .sort((a, b) => {
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <IOSBadge variant="light" color={getSeverityColor(alert.severity)} className="flex-shrink-0">
                      {alert.severity}
                    </IOSBadge>
                  </div>
