...
import { Lock, Unlock, Calendar, CheckSquare, AlertTriangle, ShieldCheck, ArrowRight, FileText, Info } from 'lucide-react';
                    ...
                    <div className="card-elevated p-6 border-l-4 border-l-stone-900">
                        <div className="flex items-start justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-[16px] font-bold text-stone-900">Current Period: January 2024</h3>
                                    <p className="text-[12px] text-stone-500 font-medium">Fiscal Year: 2023/2024 • Ends in 24 days</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <span className="px-3 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-full text-[11px] font-bold">ACTIVE</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-elevated p-6 space-y-4">
                        ...
                        <div className="p-3 bg-amber-50 border border-amber-100 rounded-lg flex items-start gap-2">
                            ...
                            <p className="text-[11px] text-amber-700 leading-relaxed font-medium">
                                2 tasks are still pending. Reconciliations must be 100% matched before final close.
                            </p>
                        </div>

                        <button
                            onClick={handleClosePeriod}
                            className={`w-full py-3 rounded-xl font-bold text-[13px] transition-all flex items-center justify-center gap-2 ${allCompleted
