          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4">
              <div className="flex items-center gap-3">
                <Package className="h-8 w-8 text-[#007AFF]" />
                <div>
            ...
            <IOSCard className="p-4 border-l-4 border-red-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#FF3B30]">{stats.outOfStock}</p>
                </div>
              </div>
            </IOSCard>
            <IOSCard className="p-4 border-l-4 border-green-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#34C759]">{stats.adequate}</p>
                </div>
              </div>
            </IOSCard>
          </div>
