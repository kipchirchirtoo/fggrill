...
import AgingAnalysisDashboard from '@/components/accounting/AgingAnalysisDashboard';
        ...
        <ProtectedRoute allowedRoles={[UserRole.BRANCH_ACCOUNTANT, UserRole.ACCOUNTANT, UserRole.GENERAL_MANAGER, UserRole.SUPER_ADMIN]}>
            <div className="p-6 max-w-7xl mx-auto space-y-6">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[12px] font-bold text-stone-400 uppercase tracking-widest">Branch Accounting / Credit & Bills</span>
                </div>
                <AgingAnalysisDashboard />
            </div>
        </ProtectedRoute>
    );
}
