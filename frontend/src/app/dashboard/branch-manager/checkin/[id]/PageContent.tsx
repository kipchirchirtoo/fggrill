...
export default function CheckinDetailPage({ params }: CheckinDetailPageProps) {
    ...
    async function fetchBookingDetails() {
      ...
      try {
        ...
        if (response.success) {
          ...
          router.push('/dashboard/branch-manager/checkin');
        }
      } catch (error) {
      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Check-in Details</h1>
              <p className="text-gray-500">Process guest check-in</p>
            </div>
            <IOSButton 
              variant="secondary" 
              onClick={() => router.push('/dashboard/branch-manager/checkin')}
              leftIcon={<ArrowLeft />}
            >
              Back to Check-in
            </IOSButton>
            ...
            <div className="space-y-6">
              ...
              <IOSCard className="p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <IOSBadge variant="light" color={booking.status === 'checked_in' ? 'success' : 'warning'}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{booking.adults + (booking.children || 0)} ({booking.adults} adults, {booking.children || 0} children)</p>
                      </div>
                    </div>
                  </div>
                </IOSCard>
                ...
                <IOSCard className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">KES {(booking.total_amount / booking.nights).toLocaleString()} per night</p>
                    </div>
                  </div>
                </IOSCard>
