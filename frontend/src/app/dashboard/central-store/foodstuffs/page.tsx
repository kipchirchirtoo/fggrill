...
import { Apple, RefreshCw, Search, AlertTriangle, Package } from 'lucide-react';
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-[26px] font-semibold text-stone-900 tracking-[-0.02em]">Foodstuffs Store</h1>
                            </div>
                            <p className="text-stone-500 mt-0.5">Dry store and kitchen inventory management</p>
                        </div>
