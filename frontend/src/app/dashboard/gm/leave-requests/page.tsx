      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <IOSCard className="p-4"><Check className="h-6 w-6 text-[#34C759] mb-2" /><p className="text-sm text-gray-500">Approved</p><p className="text-xl font-bold text-[#34C759]">{stats.approved}</p></IOSCard>
            <IOSCard className="p-4"><X className="h-6 w-6 text-[#FF3B30] mb-2" /><p className="text-sm text-gray-500">Rejected</p><p className="text-xl font-bold text-[#FF3B30]">{stats.rejected}</p></IOSCard>
          </div>
