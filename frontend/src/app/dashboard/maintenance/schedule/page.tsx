      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">View and manage preventive maintenance schedule</p>
          </div>
          <div className="bg-white rounded-lg p-6 border border-gray-100">
            <div className="flex items-center justify-center h-64 text-gray-400">
              <div className="text-center">
                ...
                <p className="text-sm mt-2">Schedule preventive maintenance and track upcoming tasks</p>
              </div>
            </div>
          </div>
        </div>
