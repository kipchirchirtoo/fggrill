      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4"><Car className="h-6 w-6 text-[#007AFF] mb-2" /><p className="text-sm text-gray-500">Vehicles</p><p className="text-xl font-bold">{stats.vehicles}</p></IOSCard>
            ...
            <IOSCard className="p-4"><CheckCircle className="h-6 w-6 text-[#34C759] mb-2" /><p className="text-sm text-gray-500">Available</p><p className="text-xl font-bold text-[#34C759]">{stats.available}</p></IOSCard>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/dashboard/admin/vehicles">
              <IOSCard className="p-6 hover:shadow-none 0_2px_14px_rgba(0,0,0,0.06)] transition cursor-pointer">
                <div className="flex items-center gap-4">
                  <div className="p-4 bg-blue-100 rounded-ios-lg"><Car className="h-8 w-8 text-[#007AFF]" /></div>
