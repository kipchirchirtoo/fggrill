...
export default function CentralStoreDashboard() {
  ...
  const quickLinks = [
    { href: '/dashboard/central-store/inventory', icon: Package, label: 'Inventory', desc: 'All items', color: 'bg-blue-50 text-blue-600' },
    ...
    { href: '/dashboard/central-store/dispatch', icon: Truck, label: 'Dispatch', desc: 'Send stock', color: 'bg-green-50 text-green-600' },
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <IOSCard className="p-4 border-l-4 border-blue-500"><Truck className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">In Transit</p><p className="text-xl font-bold text-blue-600">{stats.inTransit}</p></IOSCard>
          </div>
