      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <IOSCard className="p-4"><Check className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Approved</p><p className="text-xl font-bold text-blue-600">{stats.approved}</p></IOSCard>
          </div>
                  ...
                  <IOSCard key={request.id} className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-ios-lg bg-blue-100 flex items-center justify-center"><Building2 className="h-6 w-6 text-blue-600" /></div>
                        <div>
