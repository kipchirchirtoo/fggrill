        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <IOSCard className="p-4">
              ...
              <p className="text-2xl font-bold text-green-600">{items.filter(i => i.is_available).length}</p>
            </IOSCard>
            <IOSCard className="p-4">
              <p className="text-sm text-gray-500">Unavailable</p>
              <p className="text-2xl font-bold text-red-600">{items.filter(i => !i.is_available).length}</p>
            </IOSCard>
          </div>
                ...
                <IOSCard key={item.id} className={`overflow-hidden ${!item.is_available ? 'opacity-60' : ''}`}>
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <p className="font-bold text-lg text-green-600">KES {item.price?.toLocaleString()}</p>
                    </div>
