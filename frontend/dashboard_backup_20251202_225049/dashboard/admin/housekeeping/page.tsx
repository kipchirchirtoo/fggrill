      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <IOSCard className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Link href="/dashboard/housekeeping/tasks"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer text-center bg-blue-50"><ClipboardList className="h-8 w-8 mx-auto mb-2 text-blue-600" /><p className="font-medium">Tasks</p></IOSCard></Link>
              <Link href="/dashboard/housekeeping/rooms"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer text-center bg-green-50"><Bed className="h-8 w-8 mx-auto mb-2 text-green-600" /><p className="font-medium">Rooms</p></IOSCard></Link>
              <Link href="/dashboard/housekeeping/staff"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer text-center bg-purple-50"><Users className="h-8 w-8 mx-auto mb-2 text-purple-600" /><p className="font-medium">Staff</p></IOSCard></Link>
              <Link href="/dashboard/housekeeping/reports"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer text-center bg-orange-50"><ClipboardList className="h-8 w-8 mx-auto mb-2 text-orange-600" /><p className="font-medium">Reports</p></IOSCard></Link>
            </div>
          </IOSCard>
        </div>
      </DashboardLayout>
