                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {take.status === 'completed' && take.completed_at && (
                          <span className="text-xs text-gray-400 flex items-center gap-1"><CheckCircle className="h-3 w-3 text-green-500" /> {new Date(take.completed_at).toLocaleDateString()}</span>
                        )}
                      </div>
                    </div>
                  </IOSCard>
