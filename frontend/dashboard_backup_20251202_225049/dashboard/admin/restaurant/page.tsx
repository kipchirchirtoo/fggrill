...
export default function AdminRestaurantPage() {
  ...
  const quickLinks = [
    { href: '/dashboard/admin/restaurant/menu', icon: Menu, label: 'Menu', color: 'bg-blue-50 text-blue-600' },
    { href: '/dashboard/restaurant/orders', icon: ShoppingCart, label: 'Orders', color: 'bg-green-50 text-green-600' },
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <IOSCard className="p-4"><ShoppingCart className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Orders Today</p><p className="text-xl font-bold">{stats.orders}</p></IOSCard>
            <IOSCard className="p-4"><Utensils className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Menu Items</p><p className="text-xl font-bold">{stats.menuItems}</p></IOSCard>
            <IOSCard className="p-4"><DollarSign className="h-6 w-6 text-yellow-600 mb-2" /><p className="text-sm text-gray-500">Revenue</p><p className="text-xl font-bold text-green-600">KES {stats.revenue.toLocaleString()}</p></IOSCard>
          </div>
