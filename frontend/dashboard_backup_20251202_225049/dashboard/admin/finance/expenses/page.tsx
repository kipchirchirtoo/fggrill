      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <IOSCard className="p-4"><DollarSign className="h-6 w-6 text-red-600 mb-2" /><p className="text-sm text-gray-500">Total Expenses</p><p className="text-xl font-bold text-red-600">KES {total.toLocaleString()}</p></IOSCard>
