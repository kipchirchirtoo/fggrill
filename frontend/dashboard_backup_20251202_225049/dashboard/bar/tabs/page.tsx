...
import { CreditCard, RefreshCw, Plus, DollarSign, User, Clock, Check, X, Printer } from 'lucide-react';
          ...
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredTabs.map((tab) => (
                <IOSCard key={tab.id} className={`p-4 ${tab.status === 'open' ? 'border-l-4 border-blue-500' : ''}`}>
