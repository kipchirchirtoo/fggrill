      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4"><Wine className="h-8 w-8 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total</p><p className="text-xl font-bold">{stats.total}</p></IOSCard>
            ...
            <IOSCard className="p-4 border-l-4 border-red-500"><AlertTriangle className="h-8 w-8 text-red-600 mb-2" /><p className="text-sm text-gray-500">Out of Stock</p><p className="text-xl font-bold text-red-600">{stats.outOfStock}</p></IOSCard>
            <IOSCard className="p-4 border-l-4 border-green-500"><CheckCircle className="h-8 w-8 text-green-600 mb-2" /><p className="text-sm text-gray-500">Adequate</p><p className="text-xl font-bold text-green-600">{stats.adequate}</p></IOSCard>
          </div>
