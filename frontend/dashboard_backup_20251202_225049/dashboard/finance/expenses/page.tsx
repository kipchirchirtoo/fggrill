      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <IOSCard className="p-4"><p className="text-sm text-gray-500">Approved</p><p className="text-2xl font-bold text-green-600">KES {stats.approved.toLocaleString()}</p></IOSCard>
          </div>
                  ...
                  <IOSCard key={expense.id} className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-ios-lg bg-red-100 flex items-center justify-center"><Receipt className="h-6 w-6 text-red-600" /></div>
                        <div>
