          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <IOSCard className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div><p className="text-sm text-gray-500">Total Profit</p><p className="text-xl font-bold text-blue-600">KES {totalProfit.toLocaleString()}</p></div>
              </div>
            </IOSCard>
          </div>
                ...
                return (
                  <IOSCard key={branch.branch_id} className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-ios-lg bg-blue-100 flex items-center justify-center"><Building2 className="h-5 w-5 text-blue-600" /></div>
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-sm ${branch.profit >= 0 ? 'text-green-600' : 'text-red-600'}`}>Profit: KES {branch.profit.toLocaleString()}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-500" style={{ width: `${revenuePercent}%` }} />
                    </div>
                  </IOSCard>
                );
              })}
