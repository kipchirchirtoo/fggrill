...
export default function CentralStorePage() {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'stock' | 'transfers' | 'requests'>('stock');
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch transfers
        const transfersResponse = await fetch(`${API_URL}/api/inventory/transfers`, { headers });
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-10 pr-8 py-2 border border-gray-300 rounded-ios-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent appearance-none bg-white"
                  >
                    ...
                    {transfers
                      ...
                      .map(transfer => (
                        <tr key={transfer.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 text-sm text-gray-900">{transfer.requestedBy}</td>
                          <td className="px-6 py-4 text-sm text-gray-900">
