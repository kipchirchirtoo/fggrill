      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <motion.div
            ...
            className="bg-white rounded-ios-lg p-4 border border-gray-100"
          >
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <input
                        ...
                        className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-ios-lg focus:ring-2 focus:ring-indigo-500"
                      />
                    ) : (
          ...
          >
            ...
            <form onSubmit={handleLeaveRequest} className="space-y-4">
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-ios-lg focus:ring-2 focus:ring-indigo-500">
