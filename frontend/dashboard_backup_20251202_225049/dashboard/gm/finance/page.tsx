        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                {data.revenueChange >= 0 ? <ArrowUpRight className="h-4 w-4 text-green-500" /> : <ArrowDownRight className="h-4 w-4 text-red-500" />}
              </div>
            ...
            <IOSCard className="p-4">
              ...
              <p className={`text-xl font-bold ${data.revenueChange >= 0 ? 'text-green-600' : 'text-red-600'}`}>{data.revenueChange >= 0 ? '+' : ''}{data.revenueChange}%</p>
            </IOSCard>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <IOSCard className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between p-3 bg-gray-50 rounded-ios-lg"><span>Revenue</span><span className="font-bold text-green-600">KES {data.totalRevenue?.toLocaleString()}</span></div>
                <div className="flex justify-between p-3 bg-gray-50 rounded-ios-lg"><span>Expenses</span><span className="font-bold text-red-600">KES {data.totalExpenses?.toLocaleString()}</span></div>
                <div className="flex justify-between p-3 bg-blue-50 rounded-ios-lg font-bold"><span>Net Profit</span><span className={data.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}>KES {data.netProfit?.toLocaleString()}</span></div>
              </div>
            </IOSCard>
          </div>
        </div>
