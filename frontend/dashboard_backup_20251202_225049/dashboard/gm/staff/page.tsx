      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <IOSCard className="p-4"><Users className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total Staff</p><p className="text-xl font-bold">{stats.total}</p></IOSCard>
            <IOSCard className="p-4"><User className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Active</p><p className="text-xl font-bold text-green-600">{stats.active}</p></IOSCard>
          </div>
