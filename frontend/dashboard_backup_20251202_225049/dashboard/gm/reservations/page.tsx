      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4"><Calendar className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total</p><p className="text-xl font-bold">{stats.total}</p></IOSCard>
            ...
            <IOSCard className="p-4"><Bed className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Confirmed</p><p className="text-xl font-bold text-green-600">{stats.confirmed}</p></IOSCard>
            <IOSCard className="p-4"><User className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Checked In</p><p className="text-xl font-bold text-blue-600">{stats.checkedIn}</p></IOSCard>
          </div>
