      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4"><Building2 className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total Branches</p><p className="text-xl font-bold">{stats.total}</p></IOSCard>
            ...
            <IOSCard className="p-4"><Bed className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Total Rooms</p><p className="text-xl font-bold">{stats.totalRooms}</p></IOSCard>
            <IOSCard className="p-4"><DollarSign className="h-6 w-6 text-yellow-600 mb-2" /><p className="text-sm text-gray-500">Active</p><p className="text-xl font-bold text-green-600">{stats.active}</p></IOSCard>
          </div>
