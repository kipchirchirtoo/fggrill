...
export default function GMDashboard() {
  ...
  const quickLinks = [
    { href: '/dashboard/gm/branches', icon: Building2, label: 'Branches', desc: 'All locations', color: 'bg-blue-50 text-blue-600' },
    { href: '/dashboard/gm/finance', icon: DollarSign, label: 'Finance', desc: 'Overview', color: 'bg-green-50 text-green-600' },
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <IOSCard className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                {stats.revenueChange >= 0 ? <ArrowUpRight className="h-4 w-4 text-green-500" /> : <ArrowDownRight className="h-4 w-4 text-red-500" />}
              </div>
            ...
            <IOSCard className="p-4">
              ...
              <p className="text-lg font-bold text-green-600">+{stats.revenueChange}%</p>
            </IOSCard>
          </div>
