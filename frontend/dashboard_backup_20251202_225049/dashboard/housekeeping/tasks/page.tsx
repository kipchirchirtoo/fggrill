                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-2">
                          ...
                          {task.status === 'in_progress' && (
                            <IOSButton size="sm" className="bg-green-600" onClick={() => handleUpdateStatus(task.id, 'completed')}>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex gap-2 pt-4">
                  ...
                  {selectedTask.status === 'in_progress' && (
                    <IOSButton className="flex-1 bg-green-600" onClick={() => handleUpdateStatus(selectedTask.id, 'completed')}>
                      <Check className="h-4 w-4 mr-2" /> Complete
                    </IOSButton>
                  )}
                  <IOSButton variant="outline" className="flex-1 text-red-600" onClick={() => handleUpdateStatus(selectedTask.id, 'cancelled')}>
