              ...
              {filteredRooms.map((room) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3 rounded-xl cursor-pointer transition-all hover:scale-105 hover:shadow-lg ${statusInfo.bgColor} border-2 border-transparent hover:border-gray-300`}
                  >
