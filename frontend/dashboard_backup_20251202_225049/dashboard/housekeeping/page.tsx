      ...
      <DashboardLayout>
        <div className="space-y-6">
            ...
            <IOSCard className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-green-600">{stats.cleanRooms}</p>
                </div>
              </div>
            </IOSCard>
            <IOSCard className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-red-600">{stats.dirtyRooms}</p>
                </div>
              </div>
            </IOSCard>
            <IOSCard className="p-4">
                    ...
                    <div key={task.id} className="p-3 border rounded-ios-lg flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        ...
                        {task.status === 'in_progress' && (
                          <IOSButton size="sm" className="bg-green-600" onClick={() => handleCompleteTask(task.id)}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/dashboard/housekeeping/tasks">
              <IOSCard className="p-4 hover:shadow-lg transition cursor-pointer">
                <div className="flex items-center gap-3">
