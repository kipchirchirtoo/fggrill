      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <IOSCard className="p-4 border-l-4 border-blue-500">
            ...
            {selectedRoom && (
              <div className="space-y-4 mt-4">
                <div className="p-3 bg-blue-50 rounded-ios-lg">
                  ...
                  <p className="text-sm text-blue-600">Floor {selectedRoom.floor} • {selectedRoom.room_type}</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {inspectionChecklist.map((item) => (
                    ...
                    >
                      ...
                      {checklist[item.id] && <CheckCircle className="h-4 w-4 text-green-600 ml-auto" />}
                    </label>
                  ))}
                </div>
