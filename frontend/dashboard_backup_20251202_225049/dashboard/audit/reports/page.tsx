      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <IOSCard className="p-4"><FileText className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total Reports</p><p className="text-xl font-bold">{reports.length}</p></IOSCard>
            <IOSCard className="p-4"><CheckCircle className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Reviewed</p><p className="text-xl font-bold text-green-600">{reports.filter(r => r.status === 'reviewed').length}</p></IOSCard>
