        ...
        <div className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Link href="/dashboard/branch-store/requests"><IOSButton><ShoppingCart className="h-4 w-4 mr-2" /> Requests</IOSButton></Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <IOSCard className="p-4 border-l-4 border-red-500"><AlertTriangle className="h-6 w-6 text-red-600 mb-2" /><p className="text-sm text-gray-500">Out of Stock</p><p className="text-xl font-bold text-red-600">{items.filter(i => i.quantity === 0).length}</p></IOSCard>
          </div>
