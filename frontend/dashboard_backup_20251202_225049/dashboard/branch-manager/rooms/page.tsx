...
import { Bed, RefreshCw, CheckCircle, XCircle, Clock, Wrench } from 'lucide-react';
      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div><h1 className="text-2xl font-bold text-gray-900">Rooms</h1><p className="text-gray-500">Room status overview</p></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <IOSCard className="p-4 border-l-4 border-yellow-500"><Clock className="h-6 w-6 text-yellow-600 mb-2" /><p className="text-sm text-gray-500">Cleaning</p><p className="text-xl font-bold text-yellow-600">{stats.cleaning}</p></IOSCard>
          </div>
