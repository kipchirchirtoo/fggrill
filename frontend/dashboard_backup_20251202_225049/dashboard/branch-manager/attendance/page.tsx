      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <IOSCard className="p-4 border-l-4 border-green-500"><CheckCircle className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Present</p><p className="text-xl font-bold text-green-600">{stats.present}</p></IOSCard>
            <IOSCard className="p-4 border-l-4 border-red-500"><XCircle className="h-6 w-6 text-red-600 mb-2" /><p className="text-sm text-gray-500">Absent</p><p className="text-xl font-bold text-red-600">{stats.absent}</p></IOSCard>
