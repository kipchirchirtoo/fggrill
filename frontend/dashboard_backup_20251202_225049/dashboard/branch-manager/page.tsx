...
export default function BranchManagerDashboard() {
  ...
  const quickLinks = [
    { href: '/dashboard/branch-manager/reservations', icon: Calendar, label: 'Reservations', color: 'bg-blue-50 text-blue-600' },
    { href: '/dashboard/branch-manager/rooms', icon: Bed, label: 'Rooms', color: 'bg-green-50 text-green-600' },
    ...
    { href: '/dashboard/branch-manager/maintenance', icon: Wrench, label: 'Maintenance', color: 'bg-red-50 text-red-600' },
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <IOSCard className="p-4"><DollarSign className="h-5 w-5 text-green-600 mb-2" /><p className="text-sm text-gray-500">Revenue</p><p className="text-lg font-bold">KES {(stats.revenue / 1000).toFixed(0)}K</p></IOSCard>
            <IOSCard className="p-4"><Bed className="h-5 w-5 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Occupancy</p><p className="text-lg font-bold">{stats.occupancy}%</p></IOSCard>
            ...
            <IOSCard className="p-4"><ArrowUpRight className="h-5 w-5 text-green-600 mb-2" /><p className="text-sm text-gray-500">Arrivals</p><p className="text-lg font-bold text-green-600">{stats.arrivals}</p></IOSCard>
            <IOSCard className="p-4"><UserCheck className="h-5 w-5 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Departures</p><p className="text-lg font-bold">{stats.departures}</p></IOSCard>
          </div>
