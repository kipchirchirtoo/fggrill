      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <IOSCard className="p-4"><UserCheck className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total Departures</p><p className="text-xl font-bold">{departures.length}</p></IOSCard>
