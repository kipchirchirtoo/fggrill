      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <IOSCard className="p-4"><ArrowUpRight className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Total Arrivals</p><p className="text-xl font-bold">{arrivals.length}</p></IOSCard>
                ...
                <IOSCard key={arrival.id} className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center"><User className="h-6 w-6 text-green-600" /></div>
                      <div>
