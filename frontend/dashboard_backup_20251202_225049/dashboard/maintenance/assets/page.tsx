      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <IOSButton><Plus className="h-4 w-4 mr-2" /> Add Asset</IOSButton>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <IOSCard className="p-4"><Settings className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Total Assets</p><p className="text-xl font-bold">{stats.total}</p></IOSCard>
            <IOSCard className="p-4 border-l-4 border-green-500"><CheckCircle className="h-6 w-6 text-green-600 mb-2" /><p className="text-sm text-gray-500">Operational</p><p className="text-xl font-bold text-green-600">{stats.operational}</p></IOSCard>
            ...
            <IOSCard className="p-4 border-l-4 border-blue-500"><Wrench className="h-6 w-6 text-blue-600 mb-2" /><p className="text-sm text-gray-500">Under Repair</p><p className="text-xl font-bold text-blue-600">{stats.underRepair}</p></IOSCard>
          </div>
