      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <IOSCard className="p-4"><Wrench className="h-8 w-8 text-blue-600 mb-2" /><p className="text-sm text-gray-500">In Progress</p><p className="text-2xl font-bold text-blue-600">{stats.inProgress}</p></IOSCard>
            <IOSCard className="p-4"><CheckCircle className="h-8 w-8 text-green-600 mb-2" /><p className="text-sm text-gray-500">Completed</p><p className="text-2xl font-bold text-green-600">{stats.completed}</p></IOSCard>
            <IOSCard className="p-4"><AlertTriangle className="h-8 w-8 text-red-600 mb-2" /><p className="text-sm text-gray-500">Urgent</p><p className="text-2xl font-bold text-red-600">{stats.urgent}</p></IOSCard>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <IOSCard className="p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link href="/dashboard/maintenance/orders"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer bg-blue-50"><ClipboardList className="h-8 w-8 text-blue-600 mb-2" /><p className="font-medium">Work Orders</p></IOSCard></Link>
                <Link href="/dashboard/maintenance/assets"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer bg-green-50"><Settings className="h-8 w-8 text-green-600 mb-2" /><p className="font-medium">Assets</p></IOSCard></Link>
                <Link href="/dashboard/maintenance/schedule"><IOSCard className="p-4 hover:shadow-lg transition cursor-pointer bg-purple-50"><Calendar className="h-8 w-8 text-purple-600 mb-2" /><p className="font-medium">Schedule</p></IOSCard></Link>
              </div>
            </IOSCard>
          </div>
        </div>
