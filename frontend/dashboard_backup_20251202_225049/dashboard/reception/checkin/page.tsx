          ...
          <div className="p-4 bg-blue-50 rounded-ios-lg border border-blue-200">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-blue-600">{booking.guest_phone}</p>
              </div>
              <div className="text-right">
                <p className="font-bold">Room {booking.room_number}</p>
                <p className="text-sm text-blue-600 capitalize">{booking.room_type}</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="p-4 bg-red-50 rounded-ios-lg border border-red-200">
            <div className="flex justify-between items-start">
              <div>
                <p className="font-bold text-lg">{booking.guest_name}</p>
                <p className="text-sm text-red-600">{booking.guest_phone}</p>
              </div>
              <div className="text-right">
                <p className="font-bold">Room {booking.room_number}</p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{stats.arrivals}</p>
                </div>
              </div>
            </IOSCard>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{stats.inhouse}</p>
                </div>
              </div>
            </IOSCard>
