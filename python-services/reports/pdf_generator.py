...
class PDFReportGenerator:
    ...
    def _create_header(self, report_type, filters):
        ...
        elements.append(Paragraph(f"Famous Gate Hotel", self.styles['CustomTitle']))
    ...
    def _create_footer(self):
        ...
        footer_text = f"Generated by Famous Gate Hotel Management System | Page generated on {datetime.now().strftime('%Y-%m-%d')}"
