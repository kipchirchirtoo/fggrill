...
class PDFReportGenerator:
    ...
    def _create_header(self, report_type, filters):
        ...
        elements.append(Paragraph(f"Famous Gates Hotels", self.styles['CustomTitle']))
    ...
    def _create_footer(self):
        ...
        footer_text = f"Generated by Famous Gates Hotels Management System | Page generated on {datetime.now().strftime('%Y-%m-%d')}"
