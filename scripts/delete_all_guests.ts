...
async function deleteAllGuests() {
    ...
    // Guests table might have foreign key constraints (prominently bookings).
    // We should ideally delete bookings first or rely on cascade delete if configured.
    // Let's try deleting guests directly first.
    ...
    try {
        ...
        const { error } = await supabase
            .from('guests')
            .delete()
            .neq('id', '00000000-0000-0000-0000-000000000000'); // Delete everything (neq matches all real IDs)
